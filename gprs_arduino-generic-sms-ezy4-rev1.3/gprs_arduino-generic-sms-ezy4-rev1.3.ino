...
// Rev 1.3 - TURN ON or OFF command will not only turn ON the output but keep checking the input status also parallelly 
...
boolean outputdlyattained[4]={0,0,0,0};
...
// Bit                whatit indicates
//  7                              
//  6               1- output was turned ON using TURN command
